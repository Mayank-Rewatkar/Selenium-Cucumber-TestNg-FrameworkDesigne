package com.diligenta.transferOut;
...
//    @Test
     ...
     {
//            loadBrowser();
//            LoginPage obj_LoginPage=new LoginPage(getDriver());
//            obj_LoginPage.login();
//            obj_LoginPage.loginApplication("anshika@gmail.com","Iamking@000");
//
//            //Java Streams We are using to locate and Filtering Web Ele
//            ProductCatloguePage obj_productcatloguePage=new ProductCatloguePage(getDriver());
